...
<?php
//pagina home
require_once("../utility/Functions.php"); // file con tutte le funzioni
...
<?php
            ...
            if (!isset($_GET["NomeFilm"])) {
                ...
                echo "<h1>$nome</h1><hr>";
                echo "<div class='filmRow1'><img src='$percorsoFilm/locandina.jpg' >";
                echo "<button onclick='location.href=\"guardafilm.php?film=" . $Dati[1] . "\"' class='btn' $disabled>Guarda Subito!</button>";
                $lista = lista();
                $trovato = false;
